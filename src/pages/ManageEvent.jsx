              ...
              <form className="mt-3">
                ...
                <div className="mt-4 flex justify-between gap-2">
                  <button
                    ...
                    className="md:w-2/5 px-4 py-2 bg-white text-[#412234] font-semibold rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-[#412234] focus:ring-opacity-75 border-[#412234] border-2"
                  >
                    Delete Event
                  </button>
